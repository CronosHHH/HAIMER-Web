            ...
            <main className="overflow-hidden">
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Button
                                        onClick={handleProbarLawxia}
                                        className="hover:bg-background dark:hover:border-t-border bg-muted group mx-auto flex w-fit items-center gap-4 rounded-full border p-1 pl-4 shadow-md shadow-black/5 transition-all duration-300 dark:border-t-white/5 dark:shadow-zinc-950">
                                        <span className="text-foreground text-sm font-inter">Introducing Support for AI Models</span>
                                    ...
                                    <h1
                                        className="mt-8 max-w-4xl mx-auto text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem] font-roboto font-thin">
                                        Automatiza el Cumplimiento Normativo
                                    </h1>
                                    <p
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <span className="text-nowrap font-space-mono">Probar Lawxia</span>
                                        </Button>
                                    </div>
                                    <Button
                                        key={2}
                                        ...
                                        <Link href="/signup">
                                            <span className="text-nowrap font-inter">Registrarme</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 flex justify-center transition-all duration-500 group-hover:opacity-50">
                            <div className="flex">
                                <img
                                    className="mx-auto h-16 w-auto"
                                    src="/images/haimer-blue-logo.png"
                                    alt="HAIMER Logo"
                                    height="64"
                                    width="auto"
                                />
