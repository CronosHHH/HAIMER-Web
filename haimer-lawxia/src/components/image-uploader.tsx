...
export function ImageUploadField({
  ...
  return (
    <div className={cn("group relative font-sans text-white/90", className)}>
      <Input
        type="file"
        accept="image/*"
        className="hidden"
      ...
      <div
        className={cn(
          "relative overflow-hidden rounded-lg border-2 transition-all bg-white/[0.05]",
          "hover:bg-white/[0.08] hover:border-primary/50 cursor-pointer",
          error
